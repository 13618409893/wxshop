<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\PHPTutorial\WWW\wxshop\public/../application/admin\view\goods\index.html";i:1518766823;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <ul>
                                <li class="jstree-open">全部展开、折叠
                                    <ul>
                                        ...
                                        <li class="<?php echo $key==0?'jstree-open' : ''; ?>"><?php echo $vo['name']; ?>
                                            <ul>
